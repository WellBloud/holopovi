...
class EventsPresenter extends BasePresenter
{
    ...
    {
        dump($this->eventRepository->findAllOrderedByDateDesc());
        die();
    ...
    private function getEventsDatabase()
    {
        $events = [
            [
                'date' => '2018-02-18',
                'title' => 'Další focení s bříškem',
                'album' => '2018_foceni_brisko',
                'desc' => '<p>Verča má 11 měsíců a bráška bude za 3 měsíce na světě</p>',
                'icon' => 'picture',
            ],
            [
                'date' => '2018-01-30',
            ...
            [
                'date' => '2017-03-14',
                'title' => 'Narození Verunky',
                'album' => '2017_narozeni_verunky',
                'desc' => 'Tak se nám konečně narodila naše holčička. Jestli jí chcete něco vzkázat, můžete jí napsat na <a href="mailto:verca.holopova@gmail.com">verca.holopova@gmail.com</a> :-)',
                'icon' => 'picture',
            ],
            [
                'date' => '2016-03-27',
