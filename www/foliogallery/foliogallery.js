...
$(function () {
    ...
    $('.folioGallery').each(function () {
        ...
        // colorbox
        $(this).on('click', 'a.albumpix', function () {
            $('#' + targetDiv + ' .albumpix').colorbox({rel: targetDiv, maxWidth: '98%', maxHeight: '98%', slideshow: true, slideshowSpeed: 3500, slideshowAuto: false});
        });
